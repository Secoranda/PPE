...
hNewItem;
HMENU hPopUpMenu;
static HWND  hWidthScroll, hHeightScroll;
    ...
    case WM_HSCROLL: {
        ...
        switch (GetWindowLong((HWND)lParam, GWL_ID)) {
            case ID_SCROLLW: {
                ...
                SetScrollPos(hWidthScroll, SB_CTL, widthScroll, FALSE);
            ...
            case ID_SCROLLH: {
                ...
                SetScrollPos(hHeightScroll, SB_CTL, heightScroll, TRUE);
...
void createWindows(HWND hwnd) {
    ...
    hWidthScroll = CreateWindowEx((DWORD)NULL,
        ...
        hInstance,
        NULL);
    SetScrollRange(hWidthScroll, SB_CTL, 0, 100, TRUE);
    SetScrollPos(hWidthScroll, SB_CTL, 45, TRUE);
    ...
    hHeightScroll = CreateWindowEx((DWORD)NULL,
        ...
        hInstance,
        NULL);
    SetScrollRange(hHeightScroll, SB_CTL, 0, 100, TRUE);
    SetScrollPos(hHeightScroll, SB_CTL, 45, TRUE);
}
